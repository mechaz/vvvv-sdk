...
namespace VVVV.Nodes.Devices.Leap
{
	...
	class SampleListener : Listener
	{
		...
		public override void OnFrame (Controller controller)
		{
			...
			int FrameID= (int) frame.Id;
			int GCount = frame.Gestures().Count;
			OnRaiseCustomEvent(new CustomEventArgs(FrameID, GCount));
...
//			}
	...
	{
		public CustomEventArgs(int Frame,int GCount)
		{
			FFrame = Frame;
			FGCount = GCount;
		}
